...
board <- R6Class(classname = 'Board',
                 public = list(
                   ...
                   duplicate = function(system){
                     ...
                     while(self$y.bets$n < newBoard$y.bets$n) {newBoard$y.bets$pop()}
                     while(self$b.bets$n < newBoard$b.bets$n) {newBoard$b.bets$pop()}
                     while(self$w.bets$n < newBoard$w.bets$n) {newBoard$w.bets$pop()}
                     while(self$g.bets$n < newBoard$g.bets$n) {newBoard$g.bets$pop()}
